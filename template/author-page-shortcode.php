<div class="tfaf_admin_wrapper">
    <h1><?php esc_html_e('Shortcodes for Author Page', 'toolbox-for-asgaros-forum') ?></h1>

    <p><?php esc_html_e('To add more functionality on the WP Author Page. Just use the following Shortcodes to add the forum specific information to the Author Page.', 'toolbox-for-asgaros-forum') ?></p>
